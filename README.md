...
* **Dual Layout Engine:** Switch seamlessly between a dense **Grid Layout** for high-speed skimming and a focused **Single Row View** for granular detail analysis.
* **Smooth Sizing Controls:** Adjust sample typography rendering instantly with a high-fidelity slider control.
